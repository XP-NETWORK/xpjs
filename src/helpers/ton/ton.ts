        ...
        while (!body) {
            ...
            body = trxs.find((trx: any) => {
                ...
                trx.utime * 1000 >= +new Date(Date.now() - 1000 * 60 * 5) &&
                    console.log(
                        trx.utime,
                        "trx happend no more than 5 minutes ago"
                    );
    ...
    return {
        ...
        getExtraFees: () => {
            return new BigNumber(
                TonWeb.utils.toNano(args.extraFees).toString(10)
            );
        },
        ...
        async transferNftToForeign(
            ...
            const payload = await bridge.createFreezeBody({
                collection: nft.collectionIdent,
