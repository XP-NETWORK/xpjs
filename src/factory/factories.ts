  ...
  export const TestNet: () => Promise<Partial<ChainParams>> = async () => {
    ...
    return {
      ...
      polygonParams: {
        ...
        v3_bridge: "0x5bB1EdcACf79F59Dfa9d0e054847B33eb20d2AA4",
        nonce: Chain.POLYGON,
        feeMargin,
      },
      dfinityParams: {
      ...
      bscParams: {
        ...
        erc721_addr: "0x01aA5abAed2437D3fD547503F233f64791D74f02", //"0x783eF7485DCF27a3Cf59F5A0A406eEe3f9b2AaeB",
      ...
      hederaParams: {
        ...
        minter_addr: "0x9e6b3A673fC3fF730b79F2E3D15Aa1eA72711dD5",
  ...
  export const Staging: () => Promise<Partial<ChainParams>> = async () => {
    ...
    return {
      ...
      casperParams: {
        nwl: true,
        bridge:
          "hash-a7300a5ba39c64247263ddad7c1391c4674de073e2f35186766843eb4a1ae431",
        feeMargin,
        network: "casper",
        notifier,
      ...
      hederaParams: {
        ...
        erc1155_addr: "0x9Bf86174B058a45565EC73c15712A9a19321B862",
        minter_addr: "0x95742c7d1D4cD51d1d529Dc28bCa885c4CeF1dA4",
        erc721Minter: "0x000000000000000000000000000000000037008d",
        erc1155Minter: "0x0000000000000000000000000000000000370090",
      },
      caduceusParams: {
