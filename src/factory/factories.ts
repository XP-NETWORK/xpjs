  ...
  export const Staging: () => Promise<Partial<ChainParams>> = async () => {
    ...
    return {
      ...
      hederaParams: {
        ...
        htcToken: "0x00000000000000000000000000000000001fbea9",
        erc721_addr: "0x00000000000000000000000000000000001ebfbc",
        erc1155_addr: "0x00000000000000000000000000000000001ebfbc",
        minter_addr: "0x00000000000000000000000000000000001fbedf",
        erc721Minter: "",
        erc1155Minter: "",
      },
      caduceusParams: {
