...
export namespace ChainFactoryConfigs {
  export const TestNet: () => Promise<Partial<ChainParams>> = async () => {
    ...
    return {
      ...
      energiParams: {
        erc721Minter: "0x2a241C87a661f97BFE12fD3FAFBf7E0c9cE3D710",
        erc1155Minter: "0x1cfd0937bCf95Bc13AE64f1C2B79E3AdA0d9e0F9",
        erc1155_addr: "0x32d954b30FAcFAC04047FC0801B4b66cd42Ae489",
        erc721_addr: "0xab90671deAB3A00A5d3E92D39021accD043EDC8E",
        minter_addr: "0xb473EC14DbC5DA32B63A23C88d540cE0548320dd",
        feeMargin,
        nonce: Chain.ENERGI,
        notifier,
        noWhitelist: true,
