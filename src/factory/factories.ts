  ...
  export const TestNet: () => Promise<Partial<ChainParams>> = async () => {
    ...
    return {
      ...
      moonbeamParams: {
        ...
        erc721Minter: "0x1D5D6bB9d4e7d2e92A4414d091A78ca1539a7471",
        erc1155Minter: "0x26f95ab99A7cf22f5b88a106D8867Fb4929003ca",
        erc1155_addr: "0xDcf0c648c0CeD4222c9b8eB86fbda0c1EcC42c44",
        erc721_addr: "0x784306f82516512c0ccA69158EfcFe13A5A616F0",
        minter_addr: "0x99Fe2d42a001f3AF71238c69e3B75BD305a9bD5D",
      },
      aptosParams: {
      ...
      arbitrumParams: {
        erc721Minter: "0x247164810ff181EB4eF92052b40F6C92b7A72F6C",
        erc1155Minter: "0xA6Ca1F114Ef5D114c1B855B702Cfde813B1213cD",
        erc1155_addr: "0xfcE58D9680e05e32378C05062E026682FbE69953",
        erc721_addr: "0xF5D1B7798Aad84Beb789508E12ADB66654756Eb0",
        minter_addr: "0x1F996F65b27958C03C07f37E364afA3d3131003F",
        feeMargin,
      ...
      bitgertParams: {
        erc721Minter: "0x255DD4BD8E77c20511eA3aeC04d2d1b8b320243d",
        erc1155Minter: "0x7D5c32920c48252812E9ad583bf028bf83D88B73",
        erc1155_addr: "0x43b453a70f4a81b4bFadBe1A55E25F2cD5AAFa7B",
        erc721_addr: "0x752FaC3BDBBf2b0393923609dc8c7e720bA17119",
        minter_addr: "0x12B1E955D813EBF1539dd016D40f517Bc8748a8e",
        feeMargin,
        nonce: Chain.BITGERT,
        notifier,
      ...
      hederaParams: {
        ...
        feeMargin,
        nonce: Chain.HEDERA,
        erc721_addr: "0x00000000000000000000000000000000003b5feb",
