  ...
  export const TestNet: () => Promise<Partial<ChainParams>> = async () => {
    ...
    return {
      ...
      hederaParams: {
        ...
        nonce: Chain.HEDERA,
        noWhitelist: true,
        htcToken: "0xBFc8b960b9797A95962906521E8F9908B8413D2b",
        erc721_addr: "0x99af548a8A5A5C6447dAb163512669a335455d16",
        erc1155_addr: "0x99af548a8A5A5C6447dAb163512669a335455d16",
        minter_addr: "0x2D192BC746c033eFDb6d82D9946f9e721F805daB",
