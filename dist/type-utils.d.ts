...
declare type TransferNftChain<Signer, RawNft, Resp> = TransferNftForeign<
  Signer,
  RawNft,
  Resp
>;
...
export declare type InferSigner<K> = K extends TransferNftChain<
  infer S,
  unknown,
  unknown
>
  ? S
  : never;
export declare type InferNativeNft<K> = K extends TransferNftChain<
  any,
  infer RawNft,
  any
>
...
export declare type HelperMap<K extends ChainNonce> = Map<
  K,
