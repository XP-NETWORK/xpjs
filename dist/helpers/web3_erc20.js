...
async function web3ERC20HelperFactory(params) {
    ...
    const approveForMinter = async (id, sender, txFees) => {
        ...
        const receipt = await __1.NFT_METHOD_MAP[id.native.contractType].approve(erc, minter_addr, id.native.tokenId, txnUnderpricedPolyWorkaround, params.nonce === 0x1d ? {} : undefined);
        await receipt.wait();
